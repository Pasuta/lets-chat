    ...
    window.LCB.RoomView = Backbone.View.extend({
        ...
        addMessage: function(message) {
            ...
            var listenTags = [
                ...
                'app' + this.client.user.get('apartment'),
                'floor' + this.client.user.get('floor'),
                'parking' + this.client.user.get('parkingPlace'),
                'address' + this.client.user.get('address'),
            ].join('|');

            // WHATS MY NAME
            // message.mentioned = new RegExp('\\B@(' + this.client.user.get('username') + '|' + 'pidr' + '|all)(?!@)\\b', 'i').test(message.text);
            message.mentioned = new RegExp('\\B@(' + listenTags + ')(?!@)\\b', 'i').test(message.text);
