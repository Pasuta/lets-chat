...
+function(window, $, _) {
    ...
    window.LCB.RoomView = Backbone.View.extend({
        ...
        addMessage: function(message) {
            ...
            console.log(this.client.user.get('listenTags'));
            // WHATS MY NAME
            // message.mentioned = new RegExp('\\B@(' + this.client.user.listenTags.join('|') + ')(?!@)\\b', 'i').test(message.text);
...
+function(window, $, _) {
    ...
    window.LCB.TabsView = Backbone.View.extend({
        ...
        alert: function(message) {
            ...
            $total.text(total);
            // Just mentions
            if (new RegExp('\\B@(' + this.client.user.listenTags.join('|') + ')(?!@)\\b', 'i').test(message.text)) {
